...
export default function App() {
  ...
  return (
    <div style={{ padding: "1rem", fontFamily: "Arial, sans-serif", maxWidth: 600, margin: "0 auto" }}>
      <h1>🎲 MSH Game Template Builder</h1>
      ...
      <div style={{ margin: "1rem 0" }}>
        ...
        <select value={gameType} onChange={(e) => setGameType(e.target.value)}>
          ...
          <option value="flash">Flash Giveaway</option>
        </select>
      ...
      <div>
        <h2><Sparkles size={16} /> Live Preview</h2>
        <pre>{preview}</pre>
        <button onClick={copyToClipboard}><Copy size={16} /> Copy Template</button>
        {user && <button onClick={saveTemplate}>Save Template</button>}
      </div>
